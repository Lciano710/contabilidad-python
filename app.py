...
def mostrar_estado_resultados():
    ...
    # Aquí irá el contenido real del estado de resultados
    ttk.Label(
        frame,
        text="Contenido del Estado de Resultados se mostrará aquí",
        font=('Helvetica', 12)
    ).pack(pady=50)
...
def mostrar_flujo_efectivo(mes=None):
    ...
    # Obtener el mes actual si no se especifica
    if mes is None:
    ...
    estilo.configure('Transparent.TLabelframe', 
                   bordercolor='#4fc3f7',
                   relief='solid',
                   borderwidth=1,
                   font=('Segoe UI', 11, 'bold'))
    
    estilo.configure('Transparent.TLabelframe.Label',
                   foreground='#4fc3f7')
    
    estilo.configure("Custom.Treeview",
                   foreground='white',
                   fieldbackground='#2a3f54',
                   borderwidth=0,
                   font=('Segoe UI', 10))
...
def exportar_libro_diario(formato):
    """Exporta el libro diario con el estilo específico solicitado"""
    try:
        ...
        # Consulta modificada para evitar problemas con caracteres especiales
        cursor.execute('''
            SELECT 
                operacion_id,
...
def mostrar_reportes():
    """Muestra la interfaz para exportar reportes"""
    for widget in main_frame.winfo_children():
        widget.destroy()
    ...
    def crear_boton_exportacion(parent, texto, comando):
        ...
        ttk.Button(
            ...
            text="PDF",
            bootstyle=(DANGER, OUTLINE),
            command=lambda: comando('pdf'),
            width=10
        ).pack(side="left", padx=2)
    
    # Botones para cada reporte
    crear_boton_exportacion(frame, "Libro Diario:", exportar_libro_diario)
    crear_boton_exportacion(frame, "Libro Mayor:", exportar_libro_mayor)
    crear_boton_exportacion(frame, "Balance General:", exportar_balance_general)
    crear_boton_exportacion(frame, "Flujo de Efectivo:", exportar_flujo_efectivo)
